...
class TestService:
    ...
    def check_comments(cls, param: CommentDto):
        prompt = '''你是一个游戏公司的客服，下面的内容是游戏广告投放后用户的评论，请对以下语句进行评分，由坏到好评分范围对应着1到10分。出现讽刺阴阳怪气的，骂人嘲讽类，负面情绪的回答评分不得超过3。对于夸赞喜欢游戏的评论打高分，中性的回答分数在4-6中选一个，只需要回答多少分，不要提供额外回答。该语句是：
        ''' + param.prompt
